    ...
    <div class="mb-6">
        <div class="flex justify-between items-center">
            ...
            <div class="flex space-x-2">
                ...
                <a href="{{ route('admin.users.create-enhanced') }}" class="bg-green-600 hover:bg-green-700 text-white font-semibold py-2 px-4 rounded-lg transition-colors">
                    <i class="fas fa-user-plus mr-2"></i>
                    Tambah Pegawai Lengkap
                </a>
            </div>
        </div>
    </div>
