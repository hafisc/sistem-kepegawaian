...
@section('title', 'Tambah Riwayat Jabatan - Admin')
...
<div class="container mx-auto px-4 py-6">
    <div class="mb-6">
        <div class="flex items-center space-x-4">
            ...
            <div>
                <h1 class="text-3xl font-bold text-gray-800">Tambah Riwayat Jabatan</h1>
                <p class="text-gray-600">Tambah riwayat jabatan untuk pegawai: <strong>{{ $user->name }}</strong></p>
            </div>
        </div>
    </div>
    ...
    <form action="{{ route('admin.position-history.store', $user) }}" method="POST" class="space-y-6">
        @csrf
        ...
        <div class="bg-white rounded-lg shadow p-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                    ...
                    <input type="text" id="position_name" name="position_name" value="{{ old('position_name') }}" required 
                ...
                <div>
                    ...
                    <input type="text" id="position_level" name="position_level" value="{{ old('position_level') }}" 
                           class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:border-blue-500"
                ...
                <div>
                    ...
                    <input type="text" id="unit_kerja" name="unit_kerja" value="{{ old('unit_kerja', $user->work_unit) }}" required 
                           class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:border-blue-500"
        ...
        <div class="bg-white rounded-lg shadow p-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                    ...
                    <input type="text" id="sk_number" name="sk_number" value="{{ old('sk_number') }}" 
                           class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:border-blue-500"
                ...
                <div>
                    ...
                    <input type="date" id="sk_date" name="sk_date" value="{{ old('sk_date') }}" 
                           class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:border-blue-500">
                </div>
            </div>
